...
public class VanillaParticleMessage implements IMessage {
    ...
    public void write(final FriendlyByteBuf buffer) {
        ...
        buffer.writeResourceLocation(Registry.PARTICLE_TYPE.getKey(this.type));
    }
    ...
    public VanillaParticleMessage read(final FriendlyByteBuf buffer) {
        ...
        y = buffer.readDouble();
        z = buffer.readDouble();
        this.type = (SimpleParticleType) Registry.PARTICLE_TYPE.get(buffer.readResourceLocation());
        return this;
    }
